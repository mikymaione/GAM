...
namespace GAMSharp.UI.ColloquioPresenze
{
#if DEBUG
    sealed class Dettaglio : Base.fBaseDettaglio<DB.DataWrapper.Tabelle.ColloquioPresenze>
#else
...
#endif  
    {
...
#if DEBUG
        protected override cBaseEntity<DB.DataWrapper.Tabelle.ColloquioPresenze> getEntita()
        {
            return new DB.DataWrapper.cColloquioPresenze();
        }
        ...
        protected override DB.DataWrapper.Tabelle.ColloquioPresenze getForm()
        {
            var v = eEntity.Value;
            string e = cGB.GetSelectedComboItem_Valore(eTipo);

            var r = new DB.DataWrapper.Tabelle.ColloquioPresenze()
            {
                ID = cGB.ObjectToInt(PrimaryKey, -1),
                IDColloquio = IDColloquio_
            };
        ...
        protected override Control[] getControlliSoloInserimento(DB.DataWrapper.Tabelle.ColloquioPresenze entita)
        {
            return null;
        }
#endif

        internal Dettaglio(int IDColloquio__) : this()
        {
            IDColloquio_ = IDColloquio__;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.eEntity.Location = new System.Drawing.Point(94, 61);
            ...
            this.eTipo.Location = new System.Drawing.Point(94, 37);
            this.eTipo.Name = "eTipo";
            this.eTipo.Size = new System.Drawing.Size(259, 21);
