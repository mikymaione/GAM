...
{
#if DEBUG
    sealed class Dettaglio : Base.fBaseDettaglio<DB.DataWrapper.Tabelle.Plenaria>
#else
...
#endif  
    {
        ...
        private PlenariaPresenze.cRicerca Griglia_PlenariaPresenze;
        private string Minore_CF = "";


#if DEBUG
        protected override cBaseEntity<DB.DataWrapper.Tabelle.Plenaria> getEntita()
        {
            return new DB.DataWrapper.cPlenaria();
        }

        protected override void setForm(DB.DataWrapper.Tabelle.Plenaria e)
        {
        ...
        protected override DB.DataWrapper.Tabelle.Plenaria getForm()
        {
            return new DB.DataWrapper.Tabelle.Plenaria()
            {
        ...
        protected override Control[] getControlliSoloInserimento(DB.DataWrapper.Tabelle.Plenaria entita)
        {
            return null;
        }
#endif
        ...
        {            
            Griglia_PlenariaPresenze.IDPlenaria = cGB.ObjectToInt(PrimaryKey_, -1);
        ...
        {            
            ...
            Griglia_PlenariaPresenze.RicercaVisibile = false;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.Griglia_PlenariaPresenze = new GAMSharp.UI.PlenariaPresenze.cRicerca();
            ...
            // eDescrizione
            // 
            this.eDescrizione.Location = new System.Drawing.Point(81, 37);
            ...
            // eNote
            // 
            this.eNote.Location = new System.Drawing.Point(81, 116);
            ...
            this.eNote.Size = new System.Drawing.Size(557, 358);
            ...
            // tpPartecipanti
            // 
            this.tpPartecipanti.Controls.Add(this.Griglia_PlenariaPresenze);
            ...
            // 
            // Griglia_PlenariaPresenze
            // 
            this.Griglia_PlenariaPresenze.Dock = System.Windows.Forms.DockStyle.Fill;
            this.Griglia_PlenariaPresenze.IDPlenaria = 0;
            this.Griglia_PlenariaPresenze.Location = new System.Drawing.Point(3, 3);
            this.Griglia_PlenariaPresenze.Name = "Griglia_PlenariaPresenze";
            this.Griglia_PlenariaPresenze.Size = new System.Drawing.Size(640, 478);
            this.Griglia_PlenariaPresenze.TabIndex = 0;
            // 
            // imageList1
            // 
