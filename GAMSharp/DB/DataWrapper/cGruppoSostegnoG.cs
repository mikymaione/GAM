...
{
    sealed class cGruppoSostegnoG : Base.cBaseEntity<GruppoSostegnoG>
    {

        protected override GruppoSostegnoG Carica_Record(ref DbDataReader dr)
        {
            return new GruppoSostegnoG()
            {
        ...
        protected override DbParameter[] Inserisci_Parametri(GruppoSostegnoG entita)
        {
        ...
        protected override DbParameter[] Modifica_Parametri(GruppoSostegnoG entita)
        {
        ...
        protected override DbParameter[] Ricerca_Parametri(GruppoSostegnoG entita)
        {
            return null;
        }
